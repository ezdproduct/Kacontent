...
export const PartnerMarquee = () => {
  return (
    <div className="mt-12 overflow-hidden py-8 border-y border-primary bg-primary group">
      <h3 className="text-sm font-semibold text-primary-foreground/80 uppercase tracking-wider mb-6 text-center">
