      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center p-6 bg-card rounded-2xl shadow-lg transition-transform duration-300 hover:scale-105 hover:shadow-xl">
            ...
            <h3 className="text-lg font-semibold text-primary">Năm kinh nghiệm</h3>
          ...
          <div className="text-center p-6 bg-card rounded-2xl shadow-lg transition-transform duration-300 hover:scale-105 hover:shadow-xl">
            ...
            <h3 className="text-lg font-semibold text-primary">Chiến dịch lớn</h3>
          ...
          <div className="text-center p-6 bg-card rounded-2xl shadow-lg transition-transform duration-300 hover:scale-105 hover:shadow-xl">
            ...
            <h3 className="text-lg font-semibold text-primary">Cuộc thi</h3>
          ...
          <div className="text-center p-6 bg-card rounded-2xl shadow-lg transition-transform duration-300 hover:scale-105 hover:shadow-xl">
            ...
            <h3 className="text-lg font-semibold text-primary">Thành viên</h3>
